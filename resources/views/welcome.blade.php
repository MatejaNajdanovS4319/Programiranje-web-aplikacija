    ...
    <div class=" text-center home-hero">
        ...
        <div class="text-light">
            <div class="col-lg-6 mx-auto">
                <h1 class="display-5 fw-bold mb-3">Welcome to Mateja's DDD shop</h1>
    ...
    <div class="container mt-5 mb-3 mb-5">
        <div class="home-cards row text-center justify-content-between">
            <div class="col-md-3 card-custom mb-4">
                ...
                <p class="lead">
                    <b>Mateja's DDD</b> provides professional services desinfection of business premises, medicational
