    ...
    <footer>
        <div class="container">
            <div class="row w-100 justify-content-between text-center">
                <p class="col-md-3 text-md-start"><i class="fas fa-user"></i> Mateja Najdanov</p>
                <p class="col-md-3"><i class="fas fa-phone-alt"></i> +381605988801</p>
                <p class="col-md-3"><i class="fas fa-envelope"></i> mnajdanov4319s@gmail.com</p>
                <p class="col-md-3 text-md-end pr-0"><i class="fas fa-map-marker-alt"></i> Belgrade, Mali Mokri Lug</p>
            </div>
        </div>
    </footer>
</body>
